...
// var selectval = document.getElementById('val');//document.querySelector('select');
...
//         var modal = new bootstrap.Modal(popupDialog, {keyboard: false})
//         modal.show()
//         grid = true
//     }
//     else {
...
// popupDialog.addEventListener('hidden.bs.modal', function onClose() {
//     console.log("closed")
//     if (grid == true) {

//         createGrid(selectval.value);
//         flagdeaths =0;
...
//var g = d3.select("#legend").append("g").attr("class", "map_legend");//svg_map.append("g")
